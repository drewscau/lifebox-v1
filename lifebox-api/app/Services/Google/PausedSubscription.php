...
class PausedSubscription
{
     ...
     */
    public function handle(SubscriptionPaused $event)
    {
        $out = new ConsoleOutput();
        $out->writeln("AndroidPausedSubscription: ");
        ...
        SubscriptionService::androidRTDNInAppSubscription($productId, $purchaseToken, $isExpired, $receiptDetails, Subscription::IN_APP_STATUS_PAUSED);
    }
}
